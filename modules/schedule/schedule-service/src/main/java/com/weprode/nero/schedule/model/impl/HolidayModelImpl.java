...
import com.weprode.nero.schedule.model.HolidayModel;
...
/**
 * The base model implementation for the Holiday service. Represents a row in the &quot;Schedule_Holiday&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class HolidayModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "Schedule_Holiday";

	public static final Object[][] TABLE_COLUMNS = {
		{"holidayId", Types.BIGINT}, {"name", Types.VARCHAR},
	...
	public static final String TABLE_SQL_CREATE =
		"create table Schedule_Holiday (holidayId LONG not null primary key,name VARCHAR(75) null,startDate DATE null,endDate DATE null)";

	public static final String TABLE_SQL_DROP = "drop table Schedule_Holiday";

	public static final String ORDER_BY_JPQL =
		" ORDER BY holiday.holidayId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Schedule_Holiday.holidayId ASC";
	...
	private static Function<InvocationHandler, Holiday>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			Holiday.class.getClassLoader(), Holiday.class, ModelWrapper.class);

		try {
			Constructor<Holiday> constructor =
				(Constructor<Holiday>)proxyClass.getConstructor(
	...
	static {
		...
		attributeGetterFunctions.put("startDate", Holiday::getStartDate);
		attributeSetterBiConsumers.put(
			"startDate", (BiConsumer<Holiday, Date>)Holiday::setStartDate);
		attributeGetterFunctions.put("endDate", Holiday::getEndDate);
		attributeSetterBiConsumers.put(
			"endDate", (BiConsumer<Holiday, Date>)Holiday::setEndDate);
	...
	public Object clone() {
		...
		holidayImpl.setStartDate(getStartDate());
		holidayImpl.setEndDate(getEndDate());
	...
	public Holiday cloneWithOriginalValues() {
		...
		holidayImpl.setStartDate(
			this.<Date>getColumnOriginalValue("startDate"));
		holidayImpl.setEndDate(this.<Date>getColumnOriginalValue("endDate"));
	...
	public CacheModel<Holiday> toCacheModel() {
		...
		if (startDate != null) {
			holidayCacheModel.startDate = startDate.getTime();
		}
		else {
			holidayCacheModel.startDate = Long.MIN_VALUE;
		}

		Date endDate = getEndDate();

		if (endDate != null) {
			holidayCacheModel.endDate = endDate.getTime();
		}
		else {
			holidayCacheModel.endDate = Long.MIN_VALUE;
		}
	...
	public String toXmlString() {
		...
		for (Map.Entry<String, Function<Holiday, Object>> entry :
			...
			sb.append(attributeGetterFunction.apply((Holiday)this));
