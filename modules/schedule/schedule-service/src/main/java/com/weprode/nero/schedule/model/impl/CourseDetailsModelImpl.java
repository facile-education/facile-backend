...
public class CourseDetailsModelImpl
	...
	private static Function<InvocationHandler, CourseDetails>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			CourseDetails.class.getClassLoader(), CourseDetails.class,
			ModelWrapper.class);

		try {
			Constructor<CourseDetails> constructor =
				(Constructor<CourseDetails>)proxyClass.getConstructor(
	...
	public String toXmlString() {
		...
		for (Map.Entry<String, Function<CourseDetails, Object>> entry :
			...
			sb.append(attributeGetterFunction.apply((CourseDetails)this));
