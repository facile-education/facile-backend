...
import com.weprode.nero.schedule.model.StudentHomeworkModel;
...
/**
 * The base model implementation for the StudentHomework service. Represents a row in the &quot;Schedule_StudentHomework&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class StudentHomeworkModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "Schedule_StudentHomework";
	...
	public static final String TABLE_SQL_CREATE =
		"create table Schedule_StudentHomework (studentHomeworkId LONG not null primary key,homeworkId LONG,studentId LONG,isDone BOOLEAN,isSent BOOLEAN,sentDate DATE null,sentFileId LONG)";

	public static final String TABLE_SQL_DROP =
		"drop table Schedule_StudentHomework";

	public static final String ORDER_BY_JPQL =
		" ORDER BY studentHomework.studentHomeworkId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Schedule_StudentHomework.studentHomeworkId ASC";
	...
	private static Function<InvocationHandler, StudentHomework>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			StudentHomework.class.getClassLoader(), StudentHomework.class,
			ModelWrapper.class);

		try {
			Constructor<StudentHomework> constructor =
				(Constructor<StudentHomework>)proxyClass.getConstructor(
	...
	public String toXmlString() {
		...
		for (Map.Entry<String, Function<StudentHomework, Object>> entry :
			...
			sb.append(attributeGetterFunction.apply((StudentHomework)this));
