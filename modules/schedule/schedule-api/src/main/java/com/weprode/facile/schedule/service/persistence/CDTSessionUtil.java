...
public class CDTSessionUtil {
	...
	public static CDTSession findBygroupId_First(
		...
		throws com.weprode.facile.schedule.exception.NoSuchCDTSessionException {
