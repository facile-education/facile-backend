...
/**
 * Provides the local service utility for DailySchedule. This utility wraps
 * <code>com.weprode.nero.schedule.service.impl.DailyScheduleLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DailyScheduleLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.weprode.nero.schedule.service.impl.DailyScheduleLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DailySchedule addDailySchedule(DailySchedule dailySchedule) {
		return getService().addDailySchedule(dailySchedule);
	}

	/**
	 * Add school daily configuration for 1 given session Id
	 */
	public static void addSchoolDailySchedule(
		long schoolId, int sessionId, String sessionStartHour,
		String sessionEndHour) {

		getService().addSchoolDailySchedule(
	...
	public static DailySchedule createDailySchedule(
		...
		return getService().createDailySchedule(dailySchedulePK);
	}
	 ...
	 */
	public static DailySchedule deleteDailySchedule(
		DailySchedule dailySchedule) {

		return getService().deleteDailySchedule(dailySchedule);
	}
	...
	public static DailySchedule deleteDailySchedule(
		...
		return getService().deleteDailySchedule(dailySchedulePK);
	}
	 ...
	 */
	public static void deleteSchoolDailySchedule(long schoolId) {
		getService().deleteSchoolDailySchedule(schoolId);
	}
	...
	public static DailySchedule fetchDailySchedule(
		com.weprode.nero.schedule.service.persistence.DailySchedulePK
			dailySchedulePK) {

		return getService().fetchDailySchedule(dailySchedulePK);
	}
	...
	public static DailySchedule getDailySchedule(
		...
		return getService().getDailySchedule(dailySchedulePK);
	}
	 ...
	 */
	public static List<DailySchedule> getDailySchedules(int start, int end) {
		return getService().getDailySchedules(start, end);
	}
	 ...
	 */
	public static int getDailySchedulesCount() {
		return getService().getDailySchedulesCount();
	}
	 ...
	 */
	public static DailySchedule updateDailySchedule(
		DailySchedule dailySchedule) {

		return getService().updateDailySchedule(dailySchedule);
	}

	public static DailyScheduleLocalService getService() {
		return _service;
	}

	private static volatile DailyScheduleLocalService _service;
