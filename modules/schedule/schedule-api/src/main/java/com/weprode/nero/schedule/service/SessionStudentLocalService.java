...
public interface SessionStudentLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.nero.schedule.service.impl.SessionStudentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the session student local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SessionStudentLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	public SessionStudent addStudentToSession(long sessionId, long studentId)
