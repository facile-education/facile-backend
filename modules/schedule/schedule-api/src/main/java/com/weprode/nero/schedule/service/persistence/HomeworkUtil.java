...
public class HomeworkUtil {
	...
	public static Homework findBytargetSessionId_First(
		...
		throws com.weprode.nero.schedule.exception.NoSuchHomeworkException {
	 ...
	 * @return the matching homeworks
	 */
	public static List<Homework> findBytargetWeekId(int targetWeekId) {
	 ...
	 * @return the range of matching homeworks
	 */
	public static List<Homework> findBytargetWeekId(
	...
	public static List<Homework> findBytargetWeekId(
		...
		return getPersistence().findBytargetWeekId(
	...
	public static List<Homework> findBytargetWeekId(
		...
		return getPersistence().findBytargetWeekId(
			targetWeekId, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchHomeworkException if a matching homework could not be found
	 */
	public static Homework findBytargetWeekId_First(
			int targetWeekId, OrderByComparator<Homework> orderByComparator)
		throws com.weprode.nero.schedule.exception.NoSuchHomeworkException {

		return getPersistence().findBytargetWeekId_First(
	 ...
	 * @return the first matching homework, or <code>null</code> if a matching homework could not be found
	 */
	public static Homework fetchBytargetWeekId_First(
		int targetWeekId, OrderByComparator<Homework> orderByComparator) {

		return getPersistence().fetchBytargetWeekId_First(
			targetWeekId, orderByComparator);
	}
	 ...
	 * @throws NoSuchHomeworkException if a matching homework could not be found
	 */
	public static Homework findBytargetWeekId_Last(
			int targetWeekId, OrderByComparator<Homework> orderByComparator)
		throws com.weprode.nero.schedule.exception.NoSuchHomeworkException {

		return getPersistence().findBytargetWeekId_Last(
			targetWeekId, orderByComparator);
	}
	 ...
	 * @return the last matching homework, or <code>null</code> if a matching homework could not be found
	 */
	public static Homework fetchBytargetWeekId_Last(
		int targetWeekId, OrderByComparator<Homework> orderByComparator) {

		return getPersistence().fetchBytargetWeekId_Last(
			targetWeekId, orderByComparator);
	}
	 ...
	 * @throws NoSuchHomeworkException if a homework with the primary key could not be found
	 */
	public static Homework[] findBytargetWeekId_PrevAndNext(
			long homeworkId, int targetWeekId,
			OrderByComparator<Homework> orderByComparator)
		throws com.weprode.nero.schedule.exception.NoSuchHomeworkException {

		return getPersistence().findBytargetWeekId_PrevAndNext(
			homeworkId, targetWeekId, orderByComparator);
	}
