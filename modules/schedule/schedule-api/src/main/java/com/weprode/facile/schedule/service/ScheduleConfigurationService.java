...
/**
 * Provides the remote service interface for ScheduleConfiguration. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see ScheduleConfigurationServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface ScheduleConfigurationService extends BaseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.schedule.service.impl.ScheduleConfigurationServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the schedule configuration remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ScheduleConfigurationServiceUtil} if injection and service tracking are not available.
	 */
