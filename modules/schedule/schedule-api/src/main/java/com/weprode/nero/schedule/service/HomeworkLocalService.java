...
public interface HomeworkLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.nero.schedule.service.impl.HomeworkLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the homework local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link HomeworkLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Homework createHomework(
		User teacher, String description, long sourceSessionId,
		long targetSessionId, long groupId, Date toDate, int type,
		long estimatedTime, List<User> students);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Homework> getTeacherHomeworks(
		User teacher, Date minDate, long groupId);
