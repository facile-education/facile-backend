 ...
 * <code>com.weprode.nero.schedule.service.impl.SubjectLocalServiceImpl</code> and
...
public class SubjectLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.weprode.nero.schedule.service.impl.SubjectLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Subject createSubject(String name) {
		return getService().createSubject(name);
	}
	...
	public static Subject getOrCreateSubject(String name) {
		return getService().getOrCreateSubject(name);
	}
	...
	public static Subject getSubjectByName(String name) {
		return getService().getSubjectByName(name);
	}
