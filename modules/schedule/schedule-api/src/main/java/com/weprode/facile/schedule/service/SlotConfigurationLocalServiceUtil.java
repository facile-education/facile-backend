...
/**
 * Provides the local service utility for SlotConfiguration. This utility wraps
 * <code>com.weprode.facile.schedule.service.impl.SlotConfigurationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SlotConfigurationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.weprode.facile.schedule.service.impl.SlotConfigurationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static void addSchoolSlot(
		long schoolId, int slotNumber, String sessionStartHour,
		String sessionEndHour) {

		getService().addSchoolSlot(
	 ...
	 */
	public static SlotConfiguration addSlotConfiguration(
		SlotConfiguration slotConfiguration) {

		return getService().addSlotConfiguration(slotConfiguration);
	}
	 ...
	 */
	public static SlotConfiguration createSlotConfiguration(
		com.weprode.facile.schedule.service.persistence.SlotConfigurationPK
			slotConfigurationPK) {

		return getService().createSlotConfiguration(slotConfigurationPK);
	}
	...
	public static void deleteSchoolSlots(long schoolId) {
		getService().deleteSchoolSlots(schoolId);
	}
	 ...
	 */
	public static SlotConfiguration deleteSlotConfiguration(
		SlotConfiguration slotConfiguration) {

		return getService().deleteSlotConfiguration(slotConfiguration);
	}
	...
	public static SlotConfiguration deleteSlotConfiguration(
		...
		return getService().deleteSlotConfiguration(slotConfigurationPK);
	}
	...
	public static SlotConfiguration fetchSlotConfiguration(
		com.weprode.facile.schedule.service.persistence.SlotConfigurationPK
			slotConfigurationPK) {

		return getService().fetchSlotConfiguration(slotConfigurationPK);
	}
	...
	public static List<SlotConfiguration> getSchoolSlots(long schoolId) {
		return getService().getSchoolSlots(schoolId);
	}

	public static org.json.JSONArray getSchoolSlotsAsJson(long schoolId) {
		return getService().getSchoolSlotsAsJson(schoolId);
	}
	 ...
	 * @throws PortalException if a slot configuration with the primary key could not be found
	 */
	public static SlotConfiguration getSlotConfiguration(
			com.weprode.facile.schedule.service.persistence.SlotConfigurationPK
				slotConfigurationPK)
		throws PortalException {

		return getService().getSlotConfiguration(slotConfigurationPK);
	}
	 ...
	 */
	public static List<SlotConfiguration> getSlotConfigurations(
		int start, int end) {

		return getService().getSlotConfigurations(start, end);
	}
	 ...
	 */
	public static int getSlotConfigurationsCount() {
		return getService().getSlotConfigurationsCount();
	}

	public static void saveSchoolSlots(
		long schoolId, org.json.JSONArray jsonSlots) {

		getService().saveSchoolSlots(schoolId, jsonSlots);
	}
	 ...
	 */
	public static SlotConfiguration updateSlotConfiguration(
		SlotConfiguration slotConfiguration) {

		return getService().updateSlotConfiguration(slotConfiguration);
	}

	public static SlotConfigurationLocalService getService() {
		return _service;
	}

	private static volatile SlotConfigurationLocalService _service;
