...
/**
 * Provides the base implementation for the community infos local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.weprode.nero.group.service.impl.CommunityInfosLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.weprode.nero.group.service.impl.CommunityInfosLocalServiceImpl
 * @generated
 */
public abstract class CommunityInfosLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CommunityInfosLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CommunityInfosLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CommunityInfosLocalServiceUtil</code>.
	 */
	...
	public CommunityInfos addCommunityInfos(CommunityInfos communityInfos) {
		...
		return communityInfosPersistence.update(communityInfos);
	}
	...
	public CommunityInfos createCommunityInfos(long communityInfosId) {
		return communityInfosPersistence.create(communityInfosId);
	}
	...
	public CommunityInfos deleteCommunityInfos(long communityInfosId)
		...
		return communityInfosPersistence.remove(communityInfosId);
	}
	...
	public CommunityInfos deleteCommunityInfos(CommunityInfos communityInfos) {
		return communityInfosPersistence.remove(communityInfos);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return communityInfosPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CommunityInfos.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return communityInfosPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return communityInfosPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return communityInfosPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return communityInfosPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public CommunityInfos fetchCommunityInfos(long communityInfosId) {
		return communityInfosPersistence.fetchByPrimaryKey(communityInfosId);
	}
	...
	public CommunityInfos getCommunityInfos(long communityInfosId)
		...
		return communityInfosPersistence.findByPrimaryKey(communityInfosId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(communityInfosLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CommunityInfos.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("communityInfosId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(CommunityInfos.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return communityInfosPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CommunityInfosLocalServiceImpl#deleteCommunityInfos(CommunityInfos) to avoid orphaned data");
		}

		return communityInfosLocalService.deleteCommunityInfos(
			(CommunityInfos)persistedModel);
	}

	@Override
	public BasePersistence<CommunityInfos> getBasePersistence() {
		return communityInfosPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return communityInfosPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CommunityInfos> getCommunityInfoses(int start, int end) {
		return communityInfosPersistence.findAll(start, end);
	}
	...
	public int getCommunityInfosesCount() {
		return communityInfosPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CommunityInfosLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		communityInfosLocalService = (CommunityInfosLocalService)aopProxy;

		_setLocalServiceUtilService(communityInfosLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CommunityInfosLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = CommunityInfosLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, communityInfosLocalService);
		}
	...
	protected CommunityInfosLocalService communityInfosLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommunityInfosLocalServiceBaseImpl.class);
