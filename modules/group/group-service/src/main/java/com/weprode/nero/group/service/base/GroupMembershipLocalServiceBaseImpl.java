...
import com.weprode.nero.group.service.GroupMembershipLocalService;
...
/**
 * Provides the base implementation for the group membership local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.weprode.nero.group.service.impl.GroupMembershipLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.weprode.nero.group.service.impl.GroupMembershipLocalServiceImpl
 * @generated
 */
public abstract class GroupMembershipLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, GroupMembershipLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GroupMembershipLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>GroupMembershipLocalServiceUtil</code>.
	 */
	...
	public GroupMembership addGroupMembership(GroupMembership groupMembership) {
		...
		return groupMembershipPersistence.update(groupMembership);
	}
	...
	public GroupMembership createGroupMembership(long membershipId) {
		return groupMembershipPersistence.create(membershipId);
	}
	...
	public GroupMembership deleteGroupMembership(long membershipId)
		...
		return groupMembershipPersistence.remove(membershipId);
	}
	...
	public GroupMembership deleteGroupMembership(
		...
		return groupMembershipPersistence.remove(groupMembership);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return groupMembershipPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			GroupMembership.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return groupMembershipPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return groupMembershipPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return groupMembershipPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return groupMembershipPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public GroupMembership fetchGroupMembership(long membershipId) {
		return groupMembershipPersistence.fetchByPrimaryKey(membershipId);
	}
	...
	public GroupMembership getGroupMembership(long membershipId)
		...
		return groupMembershipPersistence.findByPrimaryKey(membershipId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(groupMembershipLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(GroupMembership.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("membershipId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			groupMembershipLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(GroupMembership.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return groupMembershipPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement GroupMembershipLocalServiceImpl#deleteGroupMembership(GroupMembership) to avoid orphaned data");
		}

		return groupMembershipLocalService.deleteGroupMembership(
			(GroupMembership)persistedModel);
	}

	@Override
	public BasePersistence<GroupMembership> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return groupMembershipPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<GroupMembership> getGroupMemberships(int start, int end) {
		return groupMembershipPersistence.findAll(start, end);
	}
	...
	public int getGroupMembershipsCount() {
		return groupMembershipPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GroupMembershipLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		groupMembershipLocalService = (GroupMembershipLocalService)aopProxy;

		_setLocalServiceUtilService(groupMembershipLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return GroupMembershipLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = groupMembershipPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				GroupMembershipLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, groupMembershipLocalService);
		}
	...
	protected GroupMembershipLocalService groupMembershipLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		GroupMembershipLocalServiceBaseImpl.class);
