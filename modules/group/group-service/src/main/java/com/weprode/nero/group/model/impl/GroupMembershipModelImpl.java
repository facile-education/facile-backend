...
public class GroupMembershipModelImpl
	...
	private static Function<InvocationHandler, GroupMembership>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			GroupMembership.class.getClassLoader(), GroupMembership.class,
			ModelWrapper.class);

		try {
			Constructor<GroupMembership> constructor =
				(Constructor<GroupMembership>)proxyClass.getConstructor(
	...
	public String toXmlString() {
		...
		for (Map.Entry<String, Function<GroupMembership, Object>> entry :
			...
			sb.append(attributeGetterFunction.apply((GroupMembership)this));
