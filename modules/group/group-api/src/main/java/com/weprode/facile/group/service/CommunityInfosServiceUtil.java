...
/**
 * Provides the remote service utility for CommunityInfos. This utility wraps
 * <code>com.weprode.facile.group.service.impl.CommunityInfosServiceImpl</code> and is an
 ...
 * @generated
 */
public class CommunityInfosServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.weprode.facile.group.service.impl.CommunityInfosServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static org.json.JSONObject createCommunity(
		...
		return getService().createCommunity(
	...
	public static org.json.JSONObject editCommunity(
		...
		return getService().editCommunity(
	...
	public static CommunityInfosService getService() {
		return _service;
	}

	private static volatile CommunityInfosService _service;
