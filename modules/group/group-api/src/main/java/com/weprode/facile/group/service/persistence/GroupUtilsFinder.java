 ...
 */
@ProviderType
public interface GroupUtilsFinder {

	public java.util.List<com.liferay.portal.kernel.model.Group> findUserGroups(
		long userId, boolean pedagogicalOnly, boolean activeOnly, int begin,
		int end);
