...
import com.weprode.facile.user.service.UserSearchService;
import com.weprode.facile.user.service.base.UserSearchServiceBaseImpl;
...
public class UserSearchServiceImpl extends UserSearchServiceBaseImpl {
    ...
    public JSONObject getSchoolStudentTeacherList (long schoolId, String search) {
        ...
        try {
            ...
            FacileLogger.registerUser(currentUser);
        } catch (Exception e) {
            return JSONProxy.getJSONReturnInErrorCase(JSONConstants.AUTH_EXCEPTION);
        }
