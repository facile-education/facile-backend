...
import com.weprode.nero.user.model.LDAPMappingModel;
...
public class LDAPMappingModelImpl
	...
	private static Function<InvocationHandler, LDAPMapping>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			LDAPMapping.class.getClassLoader(), LDAPMapping.class,
			ModelWrapper.class);

		try {
			Constructor<LDAPMapping> constructor =
				(Constructor<LDAPMapping>)proxyClass.getConstructor(
	...
	public String toXmlString() {
		...
		for (Map.Entry<String, Function<LDAPMapping, Object>> entry :
			...
			sb.append(attributeGetterFunction.apply((LDAPMapping)this));
