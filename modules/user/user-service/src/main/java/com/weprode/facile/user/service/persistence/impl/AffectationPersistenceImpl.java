...
import com.weprode.facile.user.exception.NoSuchAffectationException;
import com.weprode.facile.user.model.Affectation;
import com.weprode.facile.user.model.AffectationTable;
import com.weprode.facile.user.model.impl.AffectationImpl;
import com.weprode.facile.user.model.impl.AffectationModelImpl;
import com.weprode.facile.user.service.persistence.AffectationPersistence;
import com.weprode.facile.user.service.persistence.AffectationUtil;
...
public class AffectationPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByuserIdOrgId;
	private FinderPath _finderPathWithoutPaginationFindByuserIdOrgId;
	private FinderPath _finderPathCountByuserIdOrgId;
	 ...
	 */
	@Override
	public List<Affectation> findByuserIdOrgId(long userId, long orgId) {
		return findByuserIdOrgId(
			userId, orgId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Affectation> findByuserIdOrgId(
		long userId, long orgId, int start, int end) {

		return findByuserIdOrgId(userId, orgId, start, end, null);
	}
	...
	public List<Affectation> findByuserIdOrgId(
		...
		return findByuserIdOrgId(
			userId, orgId, start, end, orderByComparator, true);
	}
	...
	public List<Affectation> findByuserIdOrgId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByuserIdOrgId;
				finderArgs = new Object[] {userId, orgId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByuserIdOrgId;
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_USERIDORGID_USERID_2);

			sb.append(_FINDER_COLUMN_USERIDORGID_ORGID_2);
	 ...
	 */
	@Override
	public Affectation findByuserIdOrgId_First(
			long userId, long orgId,
			OrderByComparator<Affectation> orderByComparator)
		throws NoSuchAffectationException {

		Affectation affectation = fetchByuserIdOrgId_First(
	 ...
	 */
	@Override
	public Affectation fetchByuserIdOrgId_First(
		long userId, long orgId,
		OrderByComparator<Affectation> orderByComparator) {

		List<Affectation> list = findByuserIdOrgId(
			userId, orgId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Affectation findByuserIdOrgId_Last(
			long userId, long orgId,
			OrderByComparator<Affectation> orderByComparator)
		throws NoSuchAffectationException {

		Affectation affectation = fetchByuserIdOrgId_Last(
			userId, orgId, orderByComparator);
	 ...
	 */
	@Override
	public Affectation fetchByuserIdOrgId_Last(
		long userId, long orgId,
		OrderByComparator<Affectation> orderByComparator) {

		int count = countByuserIdOrgId(userId, orgId);
		...
		List<Affectation> list = findByuserIdOrgId(
			userId, orgId, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public Affectation[] findByuserIdOrgId_PrevAndNext(
		...
		try {
			...
			array[0] = getByuserIdOrgId_PrevAndNext(
				session, affectation, userId, orgId, orderByComparator, true);

			array[1] = affectation;

			array[2] = getByuserIdOrgId_PrevAndNext(
				session, affectation, userId, orgId, orderByComparator, false);
	...
	protected Affectation getByuserIdOrgId_PrevAndNext(
		Session session, Affectation affectation, long userId, long orgId,
		OrderByComparator<Affectation> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public void removeByuserIdOrgId(long userId, long orgId) {
		for (Affectation affectation :
				findByuserIdOrgId(
					userId, orgId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	 ...
	 */
	@Override
	public int countByuserIdOrgId(long userId, long orgId) {
		FinderPath finderPath = _finderPathCountByuserIdOrgId;

		Object[] finderArgs = new Object[] {userId, orgId};
	...
	private static final String _FINDER_COLUMN_USERIDORGID_USERID_2 =
		"affectation.userId = ? AND ";

	private static final String _FINDER_COLUMN_USERIDORGID_ORGID_2 =
		"affectation.orgId = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByuserIdOrgId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByuserIdOrgId",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
			},
			new String[] {"userId", "orgId"}, true);

		_finderPathWithoutPaginationFindByuserIdOrgId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByuserIdOrgId",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"userId", "orgId"}, true);

		_finderPathCountByuserIdOrgId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByuserIdOrgId",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"userId", "orgId"}, false);
