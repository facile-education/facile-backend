...
import com.weprode.facile.user.model.UserUtils;
 ...
 * @generated
 */
public abstract class UserUtilsFinderBaseImpl
	extends BasePersistenceImpl<UserUtils> {

	public UserUtilsFinderBaseImpl() {
		setModelClass(UserUtils.class);
	}
