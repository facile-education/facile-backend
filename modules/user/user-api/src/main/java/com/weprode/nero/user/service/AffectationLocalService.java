...
public interface AffectationLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.nero.user.service.impl.AffectationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the affectation local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AffectationLocalServiceUtil} if injection and service tracking are not available.
	 */
