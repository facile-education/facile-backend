...
public class NewsAdminLocalServiceWrapper
	...
	@Override
	public com.weprode.facile.user.model.NewsAdmin addDelegate()
	 ...
	 */
	@Override
	public com.weprode.facile.user.model.NewsAdmin addNewsAdmin(
		com.weprode.facile.user.model.NewsAdmin newsAdmin) {
	 ...
	 */
	@Override
	public com.weprode.facile.user.model.NewsAdmin createNewsAdmin(
		long newsAdminId) {
	 ...
	 */
	@Override
	public com.weprode.facile.user.model.NewsAdmin deleteNewsAdmin(
			long newsAdminId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public com.weprode.facile.user.model.NewsAdmin fetchNewsAdmin(
		long newsAdminId) {
	 ...
	 */
	@Override
	public com.weprode.facile.user.model.NewsAdmin getNewsAdmin(
			long newsAdminId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.weprode.facile.user.model.NewsAdmin>
		getNewsAdmins(int start, int end) {
	 ...
	 */
	@Override
	public com.weprode.facile.user.model.NewsAdmin updateNewsAdmin(
		com.weprode.facile.user.model.NewsAdmin newsAdmin) {
