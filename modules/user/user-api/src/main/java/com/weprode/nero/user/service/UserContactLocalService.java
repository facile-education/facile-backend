...
/**
 * Provides the local service interface for UserContact. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserContactLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserContactLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.nero.user.service.impl.UserContactLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user contact local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserContactLocalServiceUtil} if injection and service tracking are not available.
	 */
