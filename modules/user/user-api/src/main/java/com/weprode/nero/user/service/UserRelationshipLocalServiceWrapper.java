...
public class UserRelationshipLocalServiceWrapper
	 ...
	 */
	@Override
	public com.weprode.nero.user.model.UserRelationship addUserRelationship(
		com.weprode.nero.user.model.UserRelationship userRelationship) {
	...
	@Override
	public com.weprode.nero.user.model.UserRelationship createUserRelationship(
	...
	@Override
	public com.weprode.nero.user.model.UserRelationship createUserRelationship(
		com.weprode.nero.user.service.persistence.UserRelationshipPK
			userRelationshipPK) {
	 ...
	 */
	@Override
	public com.weprode.nero.user.model.UserRelationship deleteUserRelationship(
		com.weprode.nero.user.model.UserRelationship userRelationship) {
	...
	@Override
	public com.weprode.nero.user.model.UserRelationship fetchUserRelationship(
		com.weprode.nero.user.service.persistence.UserRelationshipPK
			userRelationshipPK) {
	 ...
	 */
	@Override
	public com.weprode.nero.user.model.UserRelationship getUserRelationship(
			com.weprode.nero.user.service.persistence.UserRelationshipPK
				userRelationshipPK)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.weprode.nero.user.model.UserRelationship>
	 ...
	 */
	@Override
	public com.weprode.nero.user.model.UserRelationship updateUserRelationship(
		com.weprode.nero.user.model.UserRelationship userRelationship) {
