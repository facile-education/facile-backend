...
public class AffectationLocalServiceWrapper
	 ...
	 */
	@Override
	public com.weprode.facile.user.model.Affectation addAffectation(
		com.weprode.facile.user.model.Affectation affectation) {
	 ...
	 */
	@Override
	public com.weprode.facile.user.model.Affectation createAffectation(
		long affectationId) {
	 ...
	 */
	@Override
	public com.weprode.facile.user.model.Affectation deleteAffectation(
		com.weprode.facile.user.model.Affectation affectation) {
	...
	@Override
	public com.weprode.facile.user.model.Affectation fetchAffectation(
		long affectationId) {
	 ...
	 */
	@Override
	public com.weprode.facile.user.model.Affectation getAffectation(
			long affectationId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.weprode.facile.user.model.Affectation>
	 ...
	 */
	@Override
	public com.weprode.facile.user.model.Affectation updateAffectation(
		com.weprode.facile.user.model.Affectation affectation) {
