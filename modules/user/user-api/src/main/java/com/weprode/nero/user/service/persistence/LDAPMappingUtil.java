...
public class LDAPMappingUtil {
	...
	public static LDAPMapping findByUID(String UID)
		throws com.weprode.nero.user.exception.NoSuchLDAPMappingException {
