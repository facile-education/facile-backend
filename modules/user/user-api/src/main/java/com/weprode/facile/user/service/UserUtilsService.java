...
/**
 * Provides the remote service interface for UserUtils. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see UserUtilsServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface UserUtilsService extends BaseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.user.service.impl.UserUtilsServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user utils remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserUtilsServiceUtil} if injection and service tracking are not available.
	 */
	...
	@JSONWebService(method = "GET", value = "get-user-infos")
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
