...
public class UserContactUtil {
	...
	public static UserContact findByuserId(long userId)
		throws com.weprode.nero.user.exception.NoSuchContactException {
