...
/**
 * Provides the remote service interface for RoleUtils. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see RoleUtilsServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface RoleUtilsService extends BaseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.role.service.impl.RoleUtilsServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the role utils remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RoleUtilsServiceUtil} if injection and service tracking are not available.
	 */
