...
import com.weprode.facile.course.service.SessionContentLocalService;
...
/**
 * Provides the base implementation for the session content local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.weprode.facile.course.service.impl.SessionContentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.weprode.facile.course.service.impl.SessionContentLocalServiceImpl
 * @generated
 */
public abstract class SessionContentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, SessionContentLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SessionContentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SessionContentLocalServiceUtil</code>.
	 */
	...
	public SessionContent createSessionContent(long sessionId) {
		return sessionContentPersistence.create(sessionId);
	}
	...
	public SessionContent deleteSessionContent(long sessionId)
		...
		return sessionContentPersistence.remove(sessionId);
	}
	...
	public SessionContent deleteSessionContent(SessionContent sessionContent) {
		return sessionContentPersistence.remove(sessionContent);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sessionContentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SessionContent.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sessionContentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return sessionContentPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sessionContentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return sessionContentPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SessionContent fetchSessionContent(long sessionId) {
		return sessionContentPersistence.fetchByPrimaryKey(sessionId);
	}
	...
	public SessionContent getSessionContent(long sessionId)
		...
		return sessionContentPersistence.findByPrimaryKey(sessionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(sessionContentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SessionContent.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SessionContent.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return sessionContentPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SessionContentLocalServiceImpl#deleteSessionContent(SessionContent) to avoid orphaned data");
		}

		return sessionContentLocalService.deleteSessionContent(
			(SessionContent)persistedModel);
	}

	@Override
	public BasePersistence<SessionContent> getBasePersistence() {
		return sessionContentPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return sessionContentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SessionContent> getSessionContents(int start, int end) {
		return sessionContentPersistence.findAll(start, end);
	}
	...
	public int getSessionContentsCount() {
		return sessionContentPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SessionContentLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sessionContentLocalService = (SessionContentLocalService)aopProxy;

		_setLocalServiceUtilService(sessionContentLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SessionContentLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = SessionContentLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, sessionContentLocalService);
		}
	...
	protected SessionContentLocalService sessionContentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SessionContentLocalServiceBaseImpl.class);
