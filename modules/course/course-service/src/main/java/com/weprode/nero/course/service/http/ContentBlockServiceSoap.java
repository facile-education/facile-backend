 ...
 * <code>com.weprode.nero.course.model.ContentBlockSoap</code>. If the method in the
 * service utility returns a
 * <code>com.weprode.nero.course.model.ContentBlock</code>, that is translated to a
 * <code>com.weprode.nero.course.model.ContentBlockSoap</code>. Methods that SOAP
 ...
 * @see ContentBlockServiceHttp
 * @deprecated As of Athanasius (7.3.x), with no direct replacement
 * @generated
 */
@Deprecated
public class ContentBlockServiceSoap {
	...
	public static org.json.JSONObject addBlock(
		...
		try {
			org.json.JSONObject returnValue = ContentBlockServiceUtil.addBlock(
	...
	public static org.json.JSONObject updateBlock(
		...
		try {
			org.json.JSONObject returnValue =
				ContentBlockServiceUtil.updateBlock(
	...
	public static org.json.JSONObject deleteBlock(long blockId)
		...
		try {
			org.json.JSONObject returnValue =
				ContentBlockServiceUtil.deleteBlock(blockId);
