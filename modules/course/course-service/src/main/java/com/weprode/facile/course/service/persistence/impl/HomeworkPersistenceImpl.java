...
import com.weprode.facile.course.exception.NoSuchHomeworkException;
import com.weprode.facile.course.model.Homework;
import com.weprode.facile.course.model.HomeworkTable;
import com.weprode.facile.course.model.impl.HomeworkImpl;
import com.weprode.facile.course.model.impl.HomeworkModelImpl;
import com.weprode.facile.course.service.persistence.HomeworkPersistence;
import com.weprode.facile.course.service.persistence.HomeworkUtil;
...
public class HomeworkPersistenceImpl
	 ...
	 */
	@Override
	public List<Homework> findBycourseId(long courseId, int start, int end) {
	 ...
	 */
	@Override
	public List<Homework> findBycourseId(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Homework homework : list) {
					if (courseId != homework.getCourseId()) {
						list = null;
	 ...
	 */
	@Override
	public Homework findBycourseId_First(
			long courseId, OrderByComparator<Homework> orderByComparator)
		throws NoSuchHomeworkException {

		Homework homework = fetchBycourseId_First(courseId, orderByComparator);
	 ...
	 */
	@Override
	public Homework fetchBycourseId_First(
		long courseId, OrderByComparator<Homework> orderByComparator) {

		List<Homework> list = findBycourseId(courseId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Homework findBycourseId_Last(
			long courseId, OrderByComparator<Homework> orderByComparator)
		throws NoSuchHomeworkException {

		Homework homework = fetchBycourseId_Last(courseId, orderByComparator);
	 ...
	 */
	@Override
	public Homework fetchBycourseId_Last(
		long courseId, OrderByComparator<Homework> orderByComparator) {
		...
		List<Homework> list = findBycourseId(
	 ...
	 */
	@Override
	public Homework[] findBycourseId_PrevAndNext(
		...
		try {
			...
			array[0] = getBycourseId_PrevAndNext(
				session, homework, courseId, orderByComparator, true);

			array[1] = homework;

			array[2] = getBycourseId_PrevAndNext(
				session, homework, courseId, orderByComparator, false);
	...
	protected Homework getBycourseId_PrevAndNext(
		Session session, Homework homework, long courseId,
