...
public class ContentBlockUtil {
	...
	public static ContentBlock findBycourseItemId_First(
			long courseItemId,
			OrderByComparator<ContentBlock> orderByComparator)
		throws com.weprode.nero.course.exception.NoSuchContentBlockException {
