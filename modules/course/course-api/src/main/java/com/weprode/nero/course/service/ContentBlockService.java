...
public interface ContentBlockService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.nero.course.service.impl.ContentBlockServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the content block remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ContentBlockServiceUtil} if injection and service tracking are not available.
	 */
