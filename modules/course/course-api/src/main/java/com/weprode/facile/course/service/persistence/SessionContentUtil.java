...
/**
 * The persistence utility for the session content service. This utility wraps <code>com.weprode.facile.course.service.persistence.impl.SessionContentPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class SessionContentUtil {
	...
	public static SessionContent remove(long sessionId)
		throws com.weprode.facile.course.exception.
			NoSuchSessionContentException {
