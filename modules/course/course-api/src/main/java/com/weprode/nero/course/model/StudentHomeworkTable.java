...
/**
 * The table class for the &quot;Course_StudentHomework&quot; database table.
 *
...
public class StudentHomeworkTable extends BaseTable<StudentHomeworkTable> {
	...
	public final Column<StudentHomeworkTable, Boolean> isCorrected =
		createColumn(
			"isCorrected", Boolean.class, Types.BOOLEAN, Column.FLAG_DEFAULT);
	public final Column<StudentHomeworkTable, String> comment = createColumn(
		"comment_", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<StudentHomeworkTable, Date> correctionDate =
		createColumn(
			"correctionDate", Date.class, Types.TIMESTAMP, Column.FLAG_DEFAULT);

	private StudentHomeworkTable() {
		super("Course_StudentHomework", StudentHomeworkTable::new);
	}
