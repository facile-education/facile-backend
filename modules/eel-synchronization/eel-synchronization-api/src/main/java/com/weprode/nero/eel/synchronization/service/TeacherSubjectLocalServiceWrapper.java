...
public class TeacherSubjectLocalServiceWrapper
	 ...
	 */
	@Override
	public com.weprode.nero.eel.synchronization.model.TeacherSubject
		addTeacherSubject(
			com.weprode.nero.eel.synchronization.model.TeacherSubject
				teacherSubject) {
	...
	@Override
	public com.weprode.nero.eel.synchronization.model.TeacherSubject
		fetchTeacherSubject(long teacherSubjectId) {
	...
	@Override
	public com.weprode.nero.eel.synchronization.model.TeacherSubject
			getTeacherSubject(long teacherSubjectId)
		throws com.liferay.portal.kernel.exception.PortalException {
