...
import com.weprode.nero.preference.model.MobileDeviceModel;
...
/**
 * The base model implementation for the MobileDevice service. Represents a row in the &quot;Preference_MobileDevice&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class MobileDeviceModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "Preference_MobileDevice";

	public static final Object[][] TABLE_COLUMNS = {
		{"mobileDeviceId", Types.BIGINT},
		{"manufaturerDeviceId", Types.VARCHAR}, {"userId", Types.BIGINT},
		{"deviceModel", Types.VARCHAR}, {"manufacturer", Types.VARCHAR},
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("manufaturerDeviceId", Types.VARCHAR);
	...
	public static final String TABLE_SQL_CREATE =
		"create table Preference_MobileDevice (mobileDeviceId LONG not null primary key,manufaturerDeviceId VARCHAR(255) null,userId LONG,deviceModel VARCHAR(75) null,manufacturer VARCHAR(75) null,operatingSystem VARCHAR(75) null,operatingSystemVersion VARCHAR(75) null,browserUA VARCHAR(500) null)";

	public static final String TABLE_SQL_DROP =
		"drop table Preference_MobileDevice";

	public static final String ORDER_BY_JPQL =
		" ORDER BY mobileDevice.mobileDeviceId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Preference_MobileDevice.mobileDeviceId ASC";
	 ...
	 */
	@Deprecated
	public static final long MANUFATURERDEVICEID_COLUMN_BITMASK = 1L;

	/**
	 * @deprecated As of Athanasius (7.3.x), replaced by {@link #getColumnBitmask(String)}
	 */
	@Deprecated
	public static final long MOBILEDEVICEID_COLUMN_BITMASK = 2L;
	...
	static {
		...
		attributeGetterFunctions.put(
			"manufaturerDeviceId", MobileDevice::getManufaturerDeviceId);
		attributeSetterBiConsumers.put(
			"manufaturerDeviceId",
			(BiConsumer<MobileDevice, String>)
				MobileDevice::setManufaturerDeviceId);
	 ...
	 */
	@Deprecated
	public long getOriginalMobileDeviceId() {
	 ...
	 */
	@Deprecated
	public String getOriginalManufaturerDeviceId() {
		return getColumnOriginalValue("manufaturerDeviceId");
	}
	...
	public Object clone() {
		...
		mobileDeviceImpl.setManufaturerDeviceId(getManufaturerDeviceId());
	...
	public MobileDevice cloneWithOriginalValues() {
		...
		mobileDeviceImpl.setManufaturerDeviceId(
			this.<String>getColumnOriginalValue("manufaturerDeviceId"));
	...
	public CacheModel<MobileDevice> toCacheModel() {
		...
		mobileDeviceCacheModel.manufaturerDeviceId = getManufaturerDeviceId();

		String manufaturerDeviceId = mobileDeviceCacheModel.manufaturerDeviceId;

		if ((manufaturerDeviceId != null) &&
			(manufaturerDeviceId.length() == 0)) {

			mobileDeviceCacheModel.manufaturerDeviceId = null;
		}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("manufaturerDeviceId", _manufaturerDeviceId);
	...
	static {
		...
		columnBitmasks.put("manufaturerDeviceId", 2L);
