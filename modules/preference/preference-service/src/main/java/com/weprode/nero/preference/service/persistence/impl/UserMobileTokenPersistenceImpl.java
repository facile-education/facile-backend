...
import com.weprode.nero.preference.exception.NoSuchUserMobileTokenException;
import com.weprode.nero.preference.model.UserMobileToken;
import com.weprode.nero.preference.model.UserMobileTokenTable;
import com.weprode.nero.preference.model.impl.UserMobileTokenImpl;
import com.weprode.nero.preference.model.impl.UserMobileTokenModelImpl;
import com.weprode.nero.preference.service.persistence.UserMobileTokenPersistence;
import com.weprode.nero.preference.service.persistence.UserMobileTokenUtil;
...
public class UserMobileTokenPersistenceImpl
	 ...
	 */
	@Override
	public List<UserMobileToken> findByuserId(long userId) {
	 ...
	 */
	@Override
	public List<UserMobileToken> findByuserId(long userId, int start, int end) {
	 ...
	 */
	@Override
	public List<UserMobileToken> findByuserId(
	...
	public List<UserMobileToken> findByuserId(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (UserMobileToken userMobileToken : list) {
					if (userId != userMobileToken.getUserId()) {
						list = null;
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(UserMobileTokenModelImpl.ORDER_BY_JPQL);
			}
	 ...
	 */
	@Override
	public UserMobileToken findByuserId_First(
			long userId, OrderByComparator<UserMobileToken> orderByComparator)
		throws NoSuchUserMobileTokenException {

		UserMobileToken userMobileToken = fetchByuserId_First(
	 ...
	 */
	@Override
	public UserMobileToken fetchByuserId_First(
		long userId, OrderByComparator<UserMobileToken> orderByComparator) {

		List<UserMobileToken> list = findByuserId(
	 ...
	 */
	@Override
	public UserMobileToken findByuserId_Last(
			long userId, OrderByComparator<UserMobileToken> orderByComparator)
		throws NoSuchUserMobileTokenException {

		UserMobileToken userMobileToken = fetchByuserId_Last(
			userId, orderByComparator);
	 ...
	 */
	@Override
	public UserMobileToken fetchByuserId_Last(
		long userId, OrderByComparator<UserMobileToken> orderByComparator) {
	 ...
	 */
	@Override
	public UserMobileToken[] findByuserId_PrevAndNext(
			long userMobileTokenId, long userId,
			OrderByComparator<UserMobileToken> orderByComparator)
		throws NoSuchUserMobileTokenException {

		UserMobileToken userMobileToken = findByPrimaryKey(userMobileTokenId);
		...
		try {
			...
			UserMobileToken[] array = new UserMobileTokenImpl[3];

			array[0] = getByuserId_PrevAndNext(
				session, userMobileToken, userId, orderByComparator, true);

			array[1] = userMobileToken;

			array[2] = getByuserId_PrevAndNext(
				session, userMobileToken, userId, orderByComparator, false);
	...
	protected UserMobileToken getByuserId_PrevAndNext(
		Session session, UserMobileToken userMobileToken, long userId,
		OrderByComparator<UserMobileToken> orderByComparator,
		boolean previous) {
	...
	public void removeByuserId(long userId) {
		for (UserMobileToken userMobileToken :
				findByuserId(
