...
/**
 * The persistence interface for the mobile notification service.
 *
 * <p>
 ...
 * @see MobileNotificationUtil
 * @generated
 */
@ProviderType
public interface MobileNotificationPersistence
	extends BasePersistence<MobileNotification> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MobileNotificationUtil} to access the mobile notification persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<MobileNotification> findByuserId(long userId);
	 ...
	 */
	public java.util.List<MobileNotification> findByuserId(
	...
	public java.util.List<MobileNotification> findByuserId(
		long userId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<MobileNotification>
			orderByComparator);
	 ...
	 * @return the matching mobile notifications
	 */
	public java.util.List<MobileNotification> findByetabId(long etabId);
	 ...
	 * @return the range of matching mobile notifications
	 */
	public java.util.List<MobileNotification> findByetabId(
	 ...
	 * @return the matching mobile notifications
	 */
	public java.util.List<MobileNotification> findByuserId_enable(
	 ...
	 * @return the matching mobile notifications
	 */
	public java.util.List<MobileNotification> findByetabId_enable(
	...
	public void cacheResult(
		java.util.List<MobileNotification> mobileNotifications);
	...
	public MobileNotification updateImpl(MobileNotification mobileNotification);
	 ...
	 */
	public java.util.List<MobileNotification> findAll();
	 ...
	 */
	public java.util.List<MobileNotification> findAll(int start, int end);
