...
/**
 * Provides the local service interface for NotifyConfig. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NotifyConfigLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NotifyConfigLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.preference.service.impl.NotifyConfigLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the notify config local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NotifyConfigLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public void deleteNotifyConfigByUser(long userId)
		throws NoSuchNotifyConfigException, SystemException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NotifyConfig> getNotifyConfigActivate(boolean activate)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NotifyConfig> getNotifyConfigActivateDigestPeriod(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NotifyConfig getOrCreateNotifyConfig(long userId)
		throws SystemException;
