...
public class MobileDeviceUtil {
	 ...
	 */
	public static MobileDevice findBymobileDeviceId(long mobileDeviceId)
		throws com.weprode.nero.preference.exception.
			NoSuchMobileDeviceException {

		return getPersistence().findBymobileDeviceId(mobileDeviceId);
	}
	 ...
	 */
	public static MobileDevice fetchBymobileDeviceId(long mobileDeviceId) {
		return getPersistence().fetchBymobileDeviceId(mobileDeviceId);
	}
	 ...
	 * @return the matching mobile device, or <code>null</code> if a matching mobile device could not be found
	 */
	public static MobileDevice fetchBymobileDeviceId(
		long mobileDeviceId, boolean useFinderCache) {

		return getPersistence().fetchBymobileDeviceId(
			mobileDeviceId, useFinderCache);
	}
	 ...
	 */
	public static MobileDevice removeBymobileDeviceId(long mobileDeviceId)
		throws com.weprode.nero.preference.exception.
			NoSuchMobileDeviceException {

		return getPersistence().removeBymobileDeviceId(mobileDeviceId);
	}
	 ...
	 */
	public static int countBymobileDeviceId(long mobileDeviceId) {
		return getPersistence().countBymobileDeviceId(mobileDeviceId);
	}
	 ...
	 * @throws NoSuchMobileDeviceException if a matching mobile device could not be found
	 */
	public static MobileDevice findBymanufaturerDeviceId(
			String manufaturerDeviceId)
		throws com.weprode.nero.preference.exception.
			NoSuchMobileDeviceException {

		return getPersistence().findBymanufaturerDeviceId(manufaturerDeviceId);
	}
	 ...
	 * @return the matching mobile device, or <code>null</code> if a matching mobile device could not be found
	 */
	public static MobileDevice fetchBymanufaturerDeviceId(
		String manufaturerDeviceId) {

		return getPersistence().fetchBymanufaturerDeviceId(manufaturerDeviceId);
	}
	...
	public static MobileDevice fetchBymanufaturerDeviceId(
		...
		return getPersistence().fetchBymanufaturerDeviceId(
			manufaturerDeviceId, useFinderCache);
	}
	 ...
	 * @return the mobile device that was removed
	 */
	public static MobileDevice removeBymanufaturerDeviceId(
			String manufaturerDeviceId)
		throws com.weprode.nero.preference.exception.
			NoSuchMobileDeviceException {

		return getPersistence().removeBymanufaturerDeviceId(
			manufaturerDeviceId);
	}
	 ...
	 * @return the number of matching mobile devices
	 */
	public static int countBymanufaturerDeviceId(String manufaturerDeviceId) {
		return getPersistence().countBymanufaturerDeviceId(manufaturerDeviceId);
	}
