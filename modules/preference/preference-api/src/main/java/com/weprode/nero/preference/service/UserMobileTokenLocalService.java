...
public interface UserMobileTokenLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.nero.preference.service.impl.UserMobileTokenLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user mobile token local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserMobileTokenLocalServiceUtil} if injection and service tracking are not available.
	 */

	/**
	 * Add new userMobileToken
	 */
	public UserMobileToken addUserMobileToken(long userId, String mobileToken)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UserMobileToken> getAllUserMobileTokens(long userId)
		throws SystemException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserMobileToken getUserMobileToken(long userId, String mobileToken)
		throws SystemException;
