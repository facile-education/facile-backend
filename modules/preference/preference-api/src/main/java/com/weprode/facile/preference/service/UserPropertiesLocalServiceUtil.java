...
/**
 * Provides the local service utility for UserProperties. This utility wraps
 * <code>com.weprode.facile.preference.service.impl.UserPropertiesLocalServiceImpl</code> and
 ...
 * @generated
 */
public class UserPropertiesLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.weprode.facile.preference.service.impl.UserPropertiesLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static UserProperties addUserProperties(long userId)
		throws SystemException {

		return getService().addUserProperties(userId);
	}
	 ...
	 */
	public static UserProperties addUserProperties(
		UserProperties userProperties) {

		return getService().addUserProperties(userProperties);
	}
	 ...
	 */
	public static UserProperties createUserProperties(long userId) {
		return getService().createUserProperties(userId);
	}
	 ...
	 */
	public static UserProperties deleteUserProperties(long userId)
		throws PortalException {

		return getService().deleteUserProperties(userId);
	}
	 ...
	 * @return the user properties that was removed
	 */
	public static UserProperties deleteUserProperties(
		UserProperties userProperties) {

		return getService().deleteUserProperties(userProperties);
	}
	...
	public static UserProperties fetchUserProperties(long userId) {
		return getService().fetchUserProperties(userId);
	}
	 ...
	 * @throws PortalException if a user properties with the primary key could not be found
	 */
	public static UserProperties getUserProperties(long userId)
		throws PortalException {

		return getService().getUserProperties(userId);
	}
	 ...
	 */
	public static List<UserProperties> getUserPropertieses(int start, int end) {
		return getService().getUserPropertieses(start, end);
	}
	 ...
	 */
	public static int getUserPropertiesesCount() {
		return getService().getUserPropertiesesCount();
	}
	 ...
	 */
	public static UserProperties updateUserProperties(
		UserProperties userProperties) {

		return getService().updateUserProperties(userProperties);
	}

	public static UserPropertiesLocalService getService() {
		return _service;
	}

	private static volatile UserPropertiesLocalService _service;
