...
public interface UserPropertiesLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.nero.preference.service.impl.UserPropertiesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user properties local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserPropertiesLocalServiceUtil} if injection and service tracking are not available.
	 */
