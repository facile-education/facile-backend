...
/**
 * Provides the local service interface for MobileNotification. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MobileNotificationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MobileNotificationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.nero.preference.service.impl.MobileNotificationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the mobile notification local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MobileNotificationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MobileNotification> getMobileNotificationByEtabId(long etabId)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MobileNotification> getMobileNotificationByEtabIdEnable(
			long etabId, Boolean enable)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MobileNotification> getMobileNotificationByUserId(long userId)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MobileNotification> getMobileNotificationByUserIdEnable(
