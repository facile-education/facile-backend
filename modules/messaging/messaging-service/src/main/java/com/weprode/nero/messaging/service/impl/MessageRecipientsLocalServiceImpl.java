...
import com.weprode.nero.messaging.service.base.MessageRecipientsLocalServiceBaseImpl;
...
@Component(
        property = "model.class.name=com.weprode.nero.messaging.model.MessageRecipients",
