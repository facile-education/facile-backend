...
public interface MessageRecipientsLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.messaging.service.impl.MessageRecipientsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the message recipients local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MessageRecipientsLocalServiceUtil} if injection and service tracking are not available.
	 */
