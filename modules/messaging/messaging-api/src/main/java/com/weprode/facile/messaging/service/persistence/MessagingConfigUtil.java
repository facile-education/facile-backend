...
public class MessagingConfigUtil {
	...
	public static MessagingConfig remove(long userId)
		throws com.weprode.facile.messaging.exception.NoSuchConfigException {
