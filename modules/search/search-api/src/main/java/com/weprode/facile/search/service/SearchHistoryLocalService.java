...
public interface SearchHistoryLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.search.service.impl.SearchHistoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the search history local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SearchHistoryLocalServiceUtil} if injection and service tracking are not available.
	 */
