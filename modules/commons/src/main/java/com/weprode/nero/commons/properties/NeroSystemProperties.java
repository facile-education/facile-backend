...
public class NeroSystemProperties {
	...
	public static final String MAIL_NO_REPLY = "mail.noreply"; // "mail.noreply.address" ?
	public static final String MAIL_NO_REPLY_USER_ID = "mail.noreply.userId";
	...
	public static final String PARENT_SYNCHRO_FOLDER = "synchro.parent.drop.folder";
