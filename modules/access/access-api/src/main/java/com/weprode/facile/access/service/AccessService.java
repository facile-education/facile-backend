...
/**
 * Provides the remote service interface for Access. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see AccessServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface AccessService extends BaseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.access.service.impl.AccessServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the access remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AccessServiceUtil} if injection and service tracking are not available.
	 */
	...
	@JSONWebService(method = "GET", value = "get-role-accesses")
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JSONObject getRoleAccesses(long schoolId, long roleId);

	@JSONWebService(method = "GET", value = "get-school-accesses")
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JSONObject getSchoolAccesses(long schoolId);

	@JSONWebService(method = "GET", value = "get-user-accesses")
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
