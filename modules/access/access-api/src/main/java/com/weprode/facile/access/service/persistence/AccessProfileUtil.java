...
public class AccessProfileUtil {
	...
	public static AccessProfile findByUuid_First(
		...
		throws com.weprode.facile.access.exception.NoSuchProfileException {
