...
/**
 * Provides the local service interface for AccessProfile. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AccessProfileLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AccessProfileLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.nero.access.service.impl.AccessProfileLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the access profile local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AccessProfileLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AccessProfile addAccessProfile(AccessProfile accessProfile);
	...
	public AccessProfile createAccessProfile(AccessProfilePK accessProfilePK);
	...
	public AccessProfile deleteAccessProfile(AccessProfile accessProfile);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AccessProfile deleteAccessProfile(AccessProfilePK accessProfilePK)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AccessProfile fetchAccessProfile(AccessProfilePK accessProfilePK);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AccessProfile getAccessProfile(AccessProfilePK accessProfilePK)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AccessProfile> getAccessProfiles(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AccessProfile updateAccessProfile(AccessProfile accessProfile);
