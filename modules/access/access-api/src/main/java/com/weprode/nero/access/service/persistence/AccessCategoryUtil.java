...
public class AccessCategoryUtil {
	...
	public static AccessCategory findByUuid_First(
		...
		throws com.weprode.nero.access.exception.NoSuchCategoryException {
