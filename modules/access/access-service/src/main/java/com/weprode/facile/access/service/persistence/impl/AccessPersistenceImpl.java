...
import com.weprode.facile.access.exception.NoSuchAccessException;
...
import com.weprode.facile.access.service.persistence.AccessUtil;
...
public class AccessPersistenceImpl
	...
	public List<Access> findByUuid(
		...
		if (useFinderCache) {
			list = (List<Access>)finderCache.getResult(
