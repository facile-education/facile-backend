...
/**
 * Provides the local service interface for EntVersion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EntVersionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EntVersionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.nero.about.service.impl.EntVersionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ent version local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EntVersionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public EntVersion addEntVersion(EntVersion entVersion);
	...
	public EntVersion createEntVersion(long entVersionId);
	...
	public EntVersion deleteEntVersion(EntVersion entVersion);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public EntVersion deleteEntVersion(long entVersionId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EntVersion fetchEntVersion(long entVersionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EntVersion getEntVersion(long entVersionId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EntVersion> getEntVersions(int start, int end);
