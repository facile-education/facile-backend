...
/**
 * The persistence interface for the version note service.
 *
 * <p>
 ...
 */
@ProviderType
public interface VersionNotePersistence extends BasePersistence<VersionNote> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VersionNoteUtil} to access the version note persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<VersionNote> versionNotes);
	 ...
	 */
	public java.util.List<VersionNote> findAll();
	 ...
	 */
	public java.util.List<VersionNote> findAll(int start, int end);
	...
	public java.util.List<VersionNote> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<VersionNote>
			orderByComparator);
