...
public interface VersionNoteService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.about.service.impl.VersionNoteServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the version note remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link VersionNoteServiceUtil} if injection and service tracking are not available.
	 */
	...
	@JSONWebService(method = "GET", value = "get-version-notes")
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
