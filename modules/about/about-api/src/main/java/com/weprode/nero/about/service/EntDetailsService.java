...
public interface EntDetailsService extends BaseService {
	 ...
	 */
	@JSONWebService(method = "POST", value = "create-version")
	public JSONObject createVersion(
	...
	@JSONWebService(method = "GET", value = "get-version-details")
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JSONObject getVersionDetails(Long versionId);

	@JSONWebService(method = "GET", value = "get-version-list")
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
