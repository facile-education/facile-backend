...
import com.weprode.facile.application.service.AuthorizedSchoolLocalService;
...
/**
 * Provides the base implementation for the authorized school local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.weprode.facile.application.service.impl.AuthorizedSchoolLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.weprode.facile.application.service.impl.AuthorizedSchoolLocalServiceImpl
 * @generated
 */
public abstract class AuthorizedSchoolLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, AuthorizedSchoolLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AuthorizedSchoolLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AuthorizedSchoolLocalServiceUtil</code>.
	 */
	...
	public AuthorizedSchool addAuthorizedSchool(
		...
		return authorizedSchoolPersistence.update(authorizedSchool);
	}
	...
	public AuthorizedSchool createAuthorizedSchool(long authorizedSchoolId) {
		return authorizedSchoolPersistence.create(authorizedSchoolId);
	}
	...
	public AuthorizedSchool deleteAuthorizedSchool(long authorizedSchoolId)
		...
		return authorizedSchoolPersistence.remove(authorizedSchoolId);
	}
	...
	public AuthorizedSchool deleteAuthorizedSchool(
		...
		return authorizedSchoolPersistence.remove(authorizedSchool);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return authorizedSchoolPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AuthorizedSchool.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return authorizedSchoolPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return authorizedSchoolPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return authorizedSchoolPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return authorizedSchoolPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AuthorizedSchool fetchAuthorizedSchool(long authorizedSchoolId) {
		return authorizedSchoolPersistence.fetchByPrimaryKey(
			authorizedSchoolId);
	}
	...
	public AuthorizedSchool getAuthorizedSchool(long authorizedSchoolId)
		...
		return authorizedSchoolPersistence.findByPrimaryKey(authorizedSchoolId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			authorizedSchoolLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AuthorizedSchool.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("authorizedSchoolId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(AuthorizedSchool.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return authorizedSchoolPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AuthorizedSchoolLocalServiceImpl#deleteAuthorizedSchool(AuthorizedSchool) to avoid orphaned data");
		}

		return authorizedSchoolLocalService.deleteAuthorizedSchool(
			(AuthorizedSchool)persistedModel);
	}

	@Override
	public BasePersistence<AuthorizedSchool> getBasePersistence() {
		return authorizedSchoolPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return authorizedSchoolPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AuthorizedSchool> getAuthorizedSchools(int start, int end) {
		return authorizedSchoolPersistence.findAll(start, end);
	}
	...
	public int getAuthorizedSchoolsCount() {
		return authorizedSchoolPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AuthorizedSchoolLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		authorizedSchoolLocalService = (AuthorizedSchoolLocalService)aopProxy;

		_setLocalServiceUtilService(authorizedSchoolLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AuthorizedSchoolLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = authorizedSchoolPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				AuthorizedSchoolLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, authorizedSchoolLocalService);
		}
	...
	protected AuthorizedSchoolLocalService authorizedSchoolLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AuthorizedSchoolLocalServiceBaseImpl.class);
