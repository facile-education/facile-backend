...
/**
 * Provides the local service interface for BroadcastRule. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BroadcastRuleLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BroadcastRuleLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.application.service.impl.BroadcastRuleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the broadcast rule local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BroadcastRuleLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public BroadcastRule addBroadcastRule(BroadcastRule broadcastRule);

	public BroadcastRule addRule(
	...
	public BroadcastRule createBroadcastRule(long broadcastRuleId);
	...
	public BroadcastRule deleteBroadcastRule(BroadcastRule broadcastRule);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public BroadcastRule deleteBroadcastRule(long broadcastRuleId)
		throws PortalException;
	 ...
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>com.weprode.facile.application.model.impl.BroadcastRuleModelImpl</code>.
	 * </p>
	 *
	 * @param dynamicQuery the dynamic query
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public BroadcastRule fetchBroadcastRule(long broadcastRuleId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public BroadcastRule getBroadcastRule(long broadcastRuleId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<BroadcastRule> getBroadcastRules(int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<BroadcastRule> getSchoolRules(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public BroadcastRule updateBroadcastRule(BroadcastRule broadcastRule);
