...
/**
 * Provides the local service interface for DefaultRole. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DefaultRoleLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DefaultRoleLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.application.service.impl.DefaultRoleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the default role local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DefaultRoleLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DefaultRole addDefaultRole(DefaultRole defaultRole);
	...
	public DefaultRole createDefaultRole(long defaultRoleId);
	...
	public DefaultRole deleteDefaultRole(DefaultRole defaultRole);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public DefaultRole deleteDefaultRole(long defaultRoleId)
		throws PortalException;

	public boolean deleteDefaultRole(long roleId, long applicationId)
		throws NoSuchDefaultRoleException, SystemException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DefaultRole fetchDefaultRole(long defaultRoleId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DefaultRole getDefaultRole(long defaultRoleId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DefaultRole> getDefaultRoles(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public DefaultRole updateDefaultRole(DefaultRole defaultRole);
