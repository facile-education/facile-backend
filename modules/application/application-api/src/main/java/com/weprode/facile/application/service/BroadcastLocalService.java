...
/**
 * Provides the local service interface for Broadcast. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BroadcastLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BroadcastLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.application.service.impl.BroadcastLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the broadcast local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BroadcastLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Broadcast createSchoolBroadcast(long applicationId, long schoolId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Broadcast getByApplicationIdEtabId(long applicationId, long schoolId)
		throws SystemException;
	...
	public Broadcast updateBroadcast(
