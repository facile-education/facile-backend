...
public class NewsAttachedFilePersistenceImpl
	...
	public NewsAttachedFile[] findBynewsId_PrevAndNext(
		...
		NewsAttachedFile newsAttachedFile = findByPrimaryKey(
			newsAttachedFilePK);
	...
	public NewsAttachedFile create(NewsAttachedFilePK newsAttachedFilePK) {
		...
		newsAttachedFile.setPrimaryKey(newsAttachedFilePK);
	...
	public NewsAttachedFile remove(NewsAttachedFilePK newsAttachedFilePK)
		...
		return remove((Serializable)newsAttachedFilePK);
	}
	...
	public NewsAttachedFile findByPrimaryKey(
		...
		return findByPrimaryKey((Serializable)newsAttachedFilePK);
	}
	...
	public NewsAttachedFile fetchByPrimaryKey(
		...
		return fetchByPrimaryKey((Serializable)newsAttachedFilePK);
	}
