...
public class NewsAttachedFileUtil {
	...
	public static NewsAttachedFile findBynewsId_First(
		...
		throws com.weprode.facile.news.exception.NoSuchAttachedFileException {
