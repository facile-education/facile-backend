...
/**
 * Provides the local service interface for NewsPopulation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NewsPopulationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NewsPopulationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.news.service.impl.NewsPopulationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the news population local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NewsPopulationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public NewsPopulation addPopulation(long newsId, long groupId, long roleId)
		throws SystemException;

	public JSONArray convertNewsPopulations(long newsId, long userId)
		throws SystemException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NewsPopulation> getNewsPopulations(long newsId)
		throws SystemException;
