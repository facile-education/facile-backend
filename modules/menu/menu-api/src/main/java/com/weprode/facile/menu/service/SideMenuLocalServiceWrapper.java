...
public class SideMenuLocalServiceWrapper
	...
	@Override
	public java.util.List<com.weprode.facile.menu.enums.MenuEntry>
		getSchoolMenu(long schoolId) {

		return _sideMenuLocalService.getSchoolMenu(schoolId);
	}

	@Override
	public java.util.List<com.weprode.facile.menu.enums.MenuEntry> getUserMenu(
