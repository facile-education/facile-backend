...
public class MenuEntry {
    ...
    public static final MenuEntry CDT = new MenuEntry(4, StringPool.BLANK, "cdt", 0, "SessionsAndHomeworks");
    ...
    public static final MenuEntry ADMINISTRATION = new MenuEntry("icon-nav-admin.svg", "administration", 6, Arrays.asList(USER_ADMIN, APPLICATION_ADMIN, HORAIRES_ADMIN, ACCESS_ADMIN, STATISTICS, MAINTENANCE));
