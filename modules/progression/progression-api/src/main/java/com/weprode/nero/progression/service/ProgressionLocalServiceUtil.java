...
/**
 * Provides the local service utility for Progression. This utility wraps
 * <code>com.weprode.nero.progression.service.impl.ProgressionLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ProgressionLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.weprode.nero.progression.service.impl.ProgressionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static Progression addProgression(
	 ...
	 */
	public static Progression addProgression(Progression progression) {
		return getService().addProgression(progression);
	}
	 ...
	 */
	public static Progression createProgression(long progressionId) {
		return getService().createProgression(progressionId);
	}
	 ...
	 */
	public static Progression deleteProgression(long progressionId)
		throws PortalException {
	 ...
	 * @return the progression that was removed
	 */
	public static Progression deleteProgression(Progression progression) {
		return getService().deleteProgression(progression);
	}

	public static void deleteProgressionById(long userId, long progressionId)
		throws PortalException, SystemException {

		getService().deleteProgressionById(userId, progressionId);
	}
	...
	public static Progression fetchProgression(long progressionId) {
		return getService().fetchProgression(progressionId);
	}
	 ...
	 * @throws PortalException if a progression with the primary key could not be found
	 */
	public static Progression getProgression(long progressionId)
		throws PortalException {

		return getService().getProgression(progressionId);
	}
	 ...
	 */
	public static List<Progression> getProgressions(int start, int end) {
		return getService().getProgressions(start, end);
	}
	 ...
	 */
	public static int getProgressionsCount() {
		return getService().getProgressionsCount();
	}

	public static List<Progression> getTeacherProgressions(long teacherId)
		throws SystemException {

		return getService().getTeacherProgressions(teacherId);
	}

	public static Progression updateProgression(
	 ...
	 */
	public static Progression updateProgression(Progression progression) {
		return getService().updateProgression(progression);
	}

	public static void updateProgressionModifiedDate(long progressionId) {
		getService().updateProgressionModifiedDate(progressionId);
	}

	public static ProgressionLocalService getService() {
		return _service;
	}

	private static volatile ProgressionLocalService _service;
