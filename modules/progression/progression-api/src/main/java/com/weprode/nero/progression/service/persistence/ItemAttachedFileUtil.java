...
/**
 * The persistence utility for the item attached file service. This utility wraps <code>com.weprode.nero.progression.service.persistence.impl.ItemAttachedFilePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see ItemAttachedFilePersistence
 * @generated
 */
public class ItemAttachedFileUtil {
	 ...
	 */
	public static void clearCache(ItemAttachedFile itemAttachedFile) {
		getPersistence().clearCache(itemAttachedFile);
	}
	 ...
	 */
	public static Map<Serializable, ItemAttachedFile> fetchByPrimaryKeys(
	 ...
	 */
	public static List<ItemAttachedFile> findWithDynamicQuery(
	 ...
	 */
	public static ItemAttachedFile update(ItemAttachedFile itemAttachedFile) {
		return getPersistence().update(itemAttachedFile);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static ItemAttachedFile update(
		ItemAttachedFile itemAttachedFile, ServiceContext serviceContext) {

		return getPersistence().update(itemAttachedFile, serviceContext);
	}
	 ...
	 */
	public static ItemAttachedFile findByitemAttachedFileId(
			long itemAttachedFileId)
		throws com.weprode.nero.progression.exception.
			NoSuchItemAttachedFileException {

		return getPersistence().findByitemAttachedFileId(itemAttachedFileId);
	}
	 ...
	 */
	public static ItemAttachedFile fetchByitemAttachedFileId(
		long itemAttachedFileId) {

		return getPersistence().fetchByitemAttachedFileId(itemAttachedFileId);
	}
	...
	public static ItemAttachedFile fetchByitemAttachedFileId(
		...
		return getPersistence().fetchByitemAttachedFileId(
			itemAttachedFileId, useFinderCache);
	}
	 ...
	 */
	public static ItemAttachedFile removeByitemAttachedFileId(
			long itemAttachedFileId)
		throws com.weprode.nero.progression.exception.
			NoSuchItemAttachedFileException {

		return getPersistence().removeByitemAttachedFileId(itemAttachedFileId);
	}
	 ...
	 */
	public static int countByitemAttachedFileId(long itemAttachedFileId) {
		return getPersistence().countByitemAttachedFileId(itemAttachedFileId);
	}
	 ...
	 */
	public static List<ItemAttachedFile> findByprogressionItemId(
	 ...
	 * @throws NoSuchItemAttachedFileException if a matching item attached file could not be found
	 */
	public static ItemAttachedFile findByprogressionItemId_First(
			long progressionItemId,
			OrderByComparator<ItemAttachedFile> orderByComparator)
		throws com.weprode.nero.progression.exception.
			NoSuchItemAttachedFileException {
	 ...
	 */
	public static ItemAttachedFile fetchByprogressionItemId_First(
		long progressionItemId,
		OrderByComparator<ItemAttachedFile> orderByComparator) {
	 ...
	 * @throws NoSuchItemAttachedFileException if a matching item attached file could not be found
	 */
	public static ItemAttachedFile findByprogressionItemId_Last(
			long progressionItemId,
			OrderByComparator<ItemAttachedFile> orderByComparator)
		throws com.weprode.nero.progression.exception.
			NoSuchItemAttachedFileException {
	 ...
	 */
	public static ItemAttachedFile fetchByprogressionItemId_Last(
		long progressionItemId,
		OrderByComparator<ItemAttachedFile> orderByComparator) {
	 ...
	 */
	public static ItemAttachedFile[] findByprogressionItemId_PrevAndNext(
		...
		return getPersistence().findByprogressionItemId_PrevAndNext(
			itemAttachedFileId, progressionItemId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(ItemAttachedFile itemAttachedFile) {
		getPersistence().cacheResult(itemAttachedFile);
	}
	 ...
	 */
	public static void cacheResult(List<ItemAttachedFile> itemAttachedFiles) {
		getPersistence().cacheResult(itemAttachedFiles);
	}
	 ...
	 */
	public static ItemAttachedFile create(long itemAttachedFileId) {
		return getPersistence().create(itemAttachedFileId);
	}
	 ...
	 * @throws NoSuchItemAttachedFileException if a item attached file with the primary key could not be found
	 */
	public static ItemAttachedFile remove(long itemAttachedFileId)
		throws com.weprode.nero.progression.exception.
			NoSuchItemAttachedFileException {

		return getPersistence().remove(itemAttachedFileId);
	}

	public static ItemAttachedFile updateImpl(
		ItemAttachedFile itemAttachedFile) {

		return getPersistence().updateImpl(itemAttachedFile);
	}
	 ...
	 * @throws NoSuchItemAttachedFileException if a item attached file with the primary key could not be found
	 */
	public static ItemAttachedFile findByPrimaryKey(long itemAttachedFileId)
		throws com.weprode.nero.progression.exception.
			NoSuchItemAttachedFileException {

		return getPersistence().findByPrimaryKey(itemAttachedFileId);
	}
	 ...
	 */
	public static ItemAttachedFile fetchByPrimaryKey(long itemAttachedFileId) {
		return getPersistence().fetchByPrimaryKey(itemAttachedFileId);
	}
	 ...
	 */
	public static List<ItemAttachedFile> findAll() {
	 ...
	 */
	public static List<ItemAttachedFile> findAll(int start, int end) {
	...
	public static ItemAttachedFilePersistence getPersistence() {
		return _persistence;
	}

	private static volatile ItemAttachedFilePersistence _persistence;
