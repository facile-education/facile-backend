...
/**
 * Provides the local service interface for ItemContent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ItemContentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ItemContentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.nero.progression.service.impl.ItemContentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the item content local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ItemContentLocalServiceUtil} if injection and service tracking are not available.
	 */
	public ItemContent addContent(
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ItemContent deleteItemContent(long contentId) throws PortalException;
	...
	public ItemContent updateContent(
