...
import com.weprode.nero.progression.service.ProgressionItemService;
...
/**
 * Provides the base implementation for the progression item remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.weprode.nero.progression.service.impl.ProgressionItemServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.weprode.nero.progression.service.impl.ProgressionItemServiceImpl
 * @generated
 */
public abstract class ProgressionItemServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ProgressionItemService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgressionItemService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgressionItemServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgressionItemService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		progressionItemService = (ProgressionItemService)aopProxy;

		_setServiceUtilService(progressionItemService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgressionItemService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = ProgressionItemServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, progressionItemService);
		}
	...
	@Reference
	protected com.weprode.nero.progression.service.ProgressionItemLocalService
		progressionItemLocalService;

	protected ProgressionItemService progressionItemService;
