 ...
 * @see ItemAttachedFileServiceSoap
 * @generated
 */
public class ItemAttachedFileServiceHttp {
	...
	public static org.json.JSONObject addAttachment(
		...
		try {
			MethodKey methodKey = new MethodKey(
				ItemAttachedFileServiceUtil.class, "addAttachment",
				_addAttachmentParameterTypes0);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, itemId, fileName, file, isToBeCompleted);
	...
	public static org.json.JSONObject deleteAttachment(
		...
		try {
			MethodKey methodKey = new MethodKey(
				ItemAttachedFileServiceUtil.class, "deleteAttachment",
				_deleteAttachmentParameterTypes1);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, attachmentId);
	...
	private static Log _log = LogFactoryUtil.getLog(
		ItemAttachedFileServiceHttp.class);

	private static final Class<?>[] _addAttachmentParameterTypes0 =
		new Class[] {
			long.class, String.class, java.io.File.class, boolean.class
		};
