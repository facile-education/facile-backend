...
package com.weprode.facile.dashboard.service;
...
/**
 * Provides the remote service interface for Dashboard. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see DashboardServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface DashboardService extends BaseService {
	...
	@JSONWebService(method = "GET", value = "get-user-schedule")
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JSONObject getUserSchedule(
		long userId, String date, boolean goForward);

	@JSONWebService(method = "GET", value = "init-dashboard")
