...
import com.weprode.facile.organization.service.base.UserOrgsLocalServiceBaseImpl;
...
@Component(
        property = "model.class.name=com.weprode.facile.organization.model.UserOrgs",
