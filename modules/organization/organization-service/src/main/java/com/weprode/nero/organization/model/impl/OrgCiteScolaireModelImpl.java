...
public class OrgCiteScolaireModelImpl
	...
	private static Function<InvocationHandler, OrgCiteScolaire>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			OrgCiteScolaire.class.getClassLoader(), OrgCiteScolaire.class,
			ModelWrapper.class);

		try {
			Constructor<OrgCiteScolaire> constructor =
				(Constructor<OrgCiteScolaire>)proxyClass.getConstructor(
	...
	public String toXmlString() {
		...
		for (Map.Entry<String, Function<OrgCiteScolaire, Object>> entry :
			...
			sb.append(attributeGetterFunction.apply((OrgCiteScolaire)this));
