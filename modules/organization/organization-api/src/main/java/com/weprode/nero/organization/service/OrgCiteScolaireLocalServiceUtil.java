...
/**
 * Provides the local service utility for OrgCiteScolaire. This utility wraps
 * <code>com.weprode.nero.organization.service.impl.OrgCiteScolaireLocalServiceImpl</code> and
 ...
 * @generated
 */
public class OrgCiteScolaireLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.weprode.nero.organization.service.impl.OrgCiteScolaireLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static OrgCiteScolaire addOrgCiteScolaire(
		OrgCiteScolaire orgCiteScolaire) {

		return getService().addOrgCiteScolaire(orgCiteScolaire);
	}
	...
	public static OrgCiteScolaire addOrgCiteScolaire(
		...
		return getService().addOrgCiteScolaire(
	 ...
	 */
	public static OrgCiteScolaire createOrgCiteScolaire(
		String childENTStructureUAI) {

		return getService().createOrgCiteScolaire(childENTStructureUAI);
	}
	 ...
	 */
	public static OrgCiteScolaire deleteOrgCiteScolaire(
		OrgCiteScolaire orgCiteScolaire) {

		return getService().deleteOrgCiteScolaire(orgCiteScolaire);
	}
	...
	public static OrgCiteScolaire deleteOrgCiteScolaire(
		...
		return getService().deleteOrgCiteScolaire(childENTStructureUAI);
	}
	...
	public static OrgCiteScolaire fetchOrgCiteScolaire(
		String childENTStructureUAI) {

		return getService().fetchOrgCiteScolaire(childENTStructureUAI);
	}
	 ...
	 * @throws PortalException if a org cite scolaire with the primary key could not be found
	 */
	public static OrgCiteScolaire getOrgCiteScolaire(
			String childENTStructureUAI)
		throws PortalException {

		return getService().getOrgCiteScolaire(childENTStructureUAI);
	}
	 ...
	 */
	public static List<OrgCiteScolaire> getOrgCiteScolaires(
		int start, int end) {

		return getService().getOrgCiteScolaires(start, end);
	}
	 ...
	 */
	public static int getOrgCiteScolairesCount() {
		return getService().getOrgCiteScolairesCount();
	}
	...
	public static List<com.liferay.portal.kernel.model.Organization>
		...
		return getService().getSchoolComplexSchools(school);
	}
	 ...
	 */
	public static OrgCiteScolaire updateOrgCiteScolaire(
		OrgCiteScolaire orgCiteScolaire) {

		return getService().updateOrgCiteScolaire(orgCiteScolaire);
	}

	public static OrgCiteScolaireLocalService getService() {
		return _service;
	}

	private static volatile OrgCiteScolaireLocalService _service;
