...
public class OrgDetailsUtil {
	 ...
	 */
	public static OrgDetails fetchByschoolId_type_role(
		long schoolId, int type, int role, boolean isArchive) {

		return getPersistence().fetchByschoolId_type_role(
			schoolId, type, role, isArchive);
	}
	...
	public static OrgDetails fetchByschoolId_type_role(
		...
		return getPersistence().fetchByschoolId_type_role(
			schoolId, type, role, isArchive, useFinderCache);
	}
	 ...
	 */
	public static OrgDetails removeByschoolId_type_role(
			long schoolId, int type, int role, boolean isArchive)
		throws com.weprode.nero.organization.exception.
			NoSuchOrgDetailsException {

		return getPersistence().removeByschoolId_type_role(
			schoolId, type, role, isArchive);
	}
	 ...
	 */
	public static int countByschoolId_type_role(
		long schoolId, int type, int role, boolean isArchive) {

		return getPersistence().countByschoolId_type_role(
			schoolId, type, role, isArchive);
	}
