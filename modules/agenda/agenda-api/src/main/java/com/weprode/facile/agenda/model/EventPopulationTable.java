...
/**
 * The table class for the &quot;Agenda_EventPopulation&quot; database table.
 *
 * @author Brian Wing Shun Chan
 * @see EventPopulation
 * @generated
 */
public class EventPopulationTable extends BaseTable<EventPopulationTable> {

	public static final EventPopulationTable INSTANCE =
		new EventPopulationTable();

	public final Column<EventPopulationTable, Long> eventId = createColumn(
		"eventId", Long.class, Types.BIGINT, Column.FLAG_PRIMARY);
	public final Column<EventPopulationTable, Long> groupId = createColumn(
