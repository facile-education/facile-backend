 ...
 * <code>com.weprode.facile.agenda.service.impl.AgendaServiceImpl</code> and is an
...
public class AgendaServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.weprode.facile.agenda.service.impl.AgendaServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static org.json.JSONObject getEvents(
		java.lang.String minDateStr, int nbEvents, boolean unreadOnly) {

		return getService().getEvents(minDateStr, nbEvents, unreadOnly);
	}
