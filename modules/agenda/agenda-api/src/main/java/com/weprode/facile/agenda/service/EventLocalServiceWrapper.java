...
public class EventLocalServiceWrapper
	 ...
	 */
	@Override
	public com.weprode.facile.agenda.model.Event addEvent(
		com.weprode.facile.agenda.model.Event event) {

		return _eventLocalService.addEvent(event);
	}

	@Override
	public org.json.JSONObject convertEventToJson(
		long userId, long eventId, boolean withDetails) {

		return _eventLocalService.convertEventToJson(
			userId, eventId, withDetails);
	}
	 ...
	 */
	@Override
	public com.weprode.facile.agenda.model.Event createEvent(long eventId) {
		return _eventLocalService.createEvent(eventId);
	}

	@Override
	public com.weprode.facile.agenda.model.Event createEvent(
	 ...
	 */
	@Override
	public com.weprode.facile.agenda.model.Event deleteEvent(
		com.weprode.facile.agenda.model.Event event) {
	 ...
	 */
	@Override
	public com.weprode.facile.agenda.model.Event deleteEvent(long eventId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public com.weprode.facile.agenda.model.Event deleteEventWithDependencies(
			long eventId)
		throws com.liferay.portal.kernel.exception.SystemException,
			   com.weprode.facile.agenda.exception.NoSuchEventException {

		return _eventLocalService.deleteEventWithDependencies(eventId);
	}
	...
	@Override
	public com.weprode.facile.agenda.model.Event fetchEvent(long eventId) {
	 ...
	 */
	@Override
	public com.weprode.facile.agenda.model.Event getEvent(long eventId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.weprode.facile.agenda.model.Event> getEvents(
		int start, int end) {
	...
	@Override
	public com.weprode.facile.agenda.model.Event modifyEvent(
	 ...
	 */
	@Override
	public com.weprode.facile.agenda.model.Event updateEvent(
		com.weprode.facile.agenda.model.Event event) {
