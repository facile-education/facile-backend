...
/**
 * Provides the local service interface for EventRead. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EventReadLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EventReadLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.agenda.service.impl.EventReadLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the event read local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EventReadLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JSONArray getEventReadStatus(long eventId, long userId)
