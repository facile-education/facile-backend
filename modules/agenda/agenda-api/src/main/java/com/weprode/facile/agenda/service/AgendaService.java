...
/**
 * Provides the remote service interface for Agenda. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see AgendaServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface AgendaService extends BaseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.agenda.service.impl.AgendaServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the agenda remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AgendaServiceUtil} if injection and service tracking are not available.
	 */
	@JSONWebService(method = "POST", value = "create-event")
	...
	@JSONWebService(method = "POST", value = "modify-event")
	public JSONObject modifyEvent(
	...
	@JSONWebService(method = "POST", value = "set-event-read")
