...
import com.weprode.facile.agenda.model.EventTable;
import com.weprode.facile.agenda.model.impl.EventImpl;
import com.weprode.facile.agenda.model.impl.EventModelImpl;
import com.weprode.facile.agenda.service.persistence.EventPersistence;
import com.weprode.facile.agenda.service.persistence.EventUtil;
...
public class EventPersistenceImpl
	...
	public Event updateImpl(Event event) {
		...
		entityCache.putResult(EventImpl.class, event, false, true);
