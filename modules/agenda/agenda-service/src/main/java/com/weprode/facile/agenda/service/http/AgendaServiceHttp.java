...
package com.weprode.facile.agenda.service.http;
...
import com.weprode.facile.agenda.service.AgendaServiceUtil;
...
public class AgendaServiceHttp {
	...
	public static org.json.JSONObject getEvents(
		HttpPrincipal httpPrincipal, String minDateStr, int nbEvents,
		boolean unreadOnly) {
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, minDateStr, nbEvents, unreadOnly);
