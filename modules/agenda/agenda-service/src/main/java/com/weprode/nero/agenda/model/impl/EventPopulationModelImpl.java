...
public class EventPopulationModelImpl
	...
	private static Function<InvocationHandler, EventPopulation>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			EventPopulation.class.getClassLoader(), EventPopulation.class,
			ModelWrapper.class);

		try {
			Constructor<EventPopulation> constructor =
				(Constructor<EventPopulation>)proxyClass.getConstructor(
	...
	public String toXmlString() {
		...
		for (Map.Entry<String, Function<EventPopulation, Object>> entry :
			...
			sb.append(attributeGetterFunction.apply((EventPopulation)this));
