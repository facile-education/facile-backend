 ...
 * @generated
 */
public class SessionStudentPK
	implements Comparable<SessionStudentPK>, Serializable {

	public long schoollifeSessionId;
	public long studentId;

	public SessionStudentPK() {
	}

	public SessionStudentPK(long schoollifeSessionId, long studentId) {
	...
	@Override
	public int compareTo(SessionStudentPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof SessionStudentPK)) {
			return false;
		}

		SessionStudentPK pk = (SessionStudentPK)object;
