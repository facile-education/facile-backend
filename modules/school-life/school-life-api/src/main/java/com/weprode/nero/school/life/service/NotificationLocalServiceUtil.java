 ...
 * <code>com.weprode.nero.school.life.service.impl.NotificationLocalServiceImpl</code> and
...
public class NotificationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.weprode.nero.school.life.service.impl.NotificationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static boolean addStudentAndParentsNotification(
		long studentId, long schoollifeSessionId) {

		return getService().addStudentAndParentsNotification(
	 ...
	 */
	public static Notification deleteNotification(
			com.weprode.nero.school.life.service.persistence.NotificationPK
				notificationPK)
		throws PortalException {
	...
	public static List<Long> getUserUnreadSchoollifeSessionIds(long userId) {
		return getService().getUserUnreadSchoollifeSessionIds(userId);
	}

	public static boolean markNotificationRead(
		long studentId, long schoollifeSessionId) {

		return getService().markNotificationRead(
			studentId, schoollifeSessionId);
	}
