...
import com.weprode.facile.school.life.service.RenvoiLocalService;
...
/**
 * Provides the base implementation for the renvoi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.weprode.facile.school.life.service.impl.RenvoiLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.weprode.facile.school.life.service.impl.RenvoiLocalServiceImpl
 * @generated
 */
public abstract class RenvoiLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, RenvoiLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RenvoiLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RenvoiLocalServiceUtil</code>.
	 */
	...
	public Renvoi addRenvoi(Renvoi renvoi) {
		...
		return renvoiPersistence.update(renvoi);
	}
	...
	public Renvoi createRenvoi(RenvoiPK renvoiPK) {
		return renvoiPersistence.create(renvoiPK);
	}
	...
	public Renvoi deleteRenvoi(RenvoiPK renvoiPK) throws PortalException {
		return renvoiPersistence.remove(renvoiPK);
	}
	...
	public Renvoi deleteRenvoi(Renvoi renvoi) {
		return renvoiPersistence.remove(renvoi);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return renvoiPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Renvoi.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return renvoiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return renvoiPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return renvoiPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return renvoiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return renvoiPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Renvoi fetchRenvoi(RenvoiPK renvoiPK) {
		return renvoiPersistence.fetchByPrimaryKey(renvoiPK);
	}
	...
	public Renvoi getRenvoi(RenvoiPK renvoiPK) throws PortalException {
		return renvoiPersistence.findByPrimaryKey(renvoiPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(renvoiLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Renvoi.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(renvoiLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Renvoi.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return renvoiPersistence.create((RenvoiPK)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement RenvoiLocalServiceImpl#deleteRenvoi(Renvoi) to avoid orphaned data");
		}

		return renvoiLocalService.deleteRenvoi((Renvoi)persistedModel);
	}

	@Override
	public BasePersistence<Renvoi> getBasePersistence() {
		return renvoiPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return renvoiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Renvoi> getRenvois(int start, int end) {
		return renvoiPersistence.findAll(start, end);
	}
	...
	public int getRenvoisCount() {
		return renvoiPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RenvoiLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		renvoiLocalService = (RenvoiLocalService)aopProxy;

		_setLocalServiceUtilService(renvoiLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RenvoiLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		RenvoiLocalService renvoiLocalService) {

		try {
			Field field = RenvoiLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, renvoiLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RenvoiLocalServiceBaseImpl.class);
