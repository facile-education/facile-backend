...
public class EditionLockUtil {
	...
	public static EditionLock findByfileId_userId(long fileId, long userId)
		throws com.weprode.facile.document.exception.
			NoSuchEditionLockException {
