...
public class LoolTokenUtil {
	...
	public static LoolToken findBytoken(String token)
		throws com.weprode.facile.document.exception.NoSuchLoolTokenException {
