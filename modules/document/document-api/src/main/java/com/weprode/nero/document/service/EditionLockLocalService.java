...
/**
 * Provides the local service interface for EditionLock. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EditionLockLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EditionLockLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.nero.document.service.impl.EditionLockLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the edition lock local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EditionLockLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public EditionLock addEditionLock(long fileId, long userId)
