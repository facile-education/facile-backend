...
import com.weprode.facile.document.service.base.VersionLocalServiceBaseImpl;
...
@Component(
	property = "model.class.name=com.weprode.facile.document.model.Version",
	...
	public JSONObject getFileVersions(User user, long fileId) {
		...
		try {
			...
			for (DLFileVersion dlFileVersion : dlFileVersionList) {
				...
				curr.put(JSONConstants.DATE, new SimpleDateFormat(JSONConstants.DATE_EXCHANGE_FORMAT)
