 ...
 * @generated
 */
public abstract class ActivityFinderBaseImpl
	extends BasePersistenceImpl<Activity> {
	...
	public Set<String> getBadColumnNames() {
		return activityPersistence.getBadColumnNames();
	}
