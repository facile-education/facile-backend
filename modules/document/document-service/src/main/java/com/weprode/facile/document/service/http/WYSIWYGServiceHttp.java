...
import com.weprode.facile.document.service.WYSIWYGServiceUtil;

/**
 * Provides the HTTP utility for the
 * <code>WYSIWYGServiceUtil</code> service
 * utility. The
...
public class WYSIWYGServiceHttp {
	...
	public static org.json.JSONObject getHTMLContent(
		...
		try {
			MethodKey methodKey = new MethodKey(
				WYSIWYGServiceUtil.class, "getHTMLContent",
				_getHTMLContentParameterTypes0);
	...
	public static org.json.JSONObject saveHTMLContent(
		...
		try {
			MethodKey methodKey = new MethodKey(
				WYSIWYGServiceUtil.class, "saveHTMLContent",
				_saveHTMLContentParameterTypes1);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, fileVersionId, content, majorVersion);
	...
	private static Log _log = LogFactoryUtil.getLog(WYSIWYGServiceHttp.class);
