...
public class MobileDeviceWrapper
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("manufacturerDeviceId", getManufacturerDeviceId());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		String manufacturerDeviceId = (String)attributes.get(
			"manufacturerDeviceId");

		if (manufacturerDeviceId != null) {
			setManufacturerDeviceId(manufacturerDeviceId);
		}
	...
	public String getManufacturerDeviceId() {
		return model.getManufacturerDeviceId();
	}
	...
	public void setManufacturerDeviceId(String manufacturerDeviceId) {
		model.setManufacturerDeviceId(manufacturerDeviceId);
	}
