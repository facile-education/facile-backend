...
public interface UserMobileTokenLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.nero.mobile.service.impl.UserMobileTokenLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user mobile token local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserMobileTokenLocalServiceUtil} if injection and service tracking are not available.
	 */
