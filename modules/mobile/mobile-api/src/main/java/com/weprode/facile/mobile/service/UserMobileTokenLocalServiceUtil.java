 ...
 * <code>com.weprode.facile.mobile.service.impl.UserMobileTokenLocalServiceImpl</code> and
...
public class UserMobileTokenLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.weprode.facile.mobile.service.impl.UserMobileTokenLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static String addMobileToken(long userId) throws SystemException {
	...
	public static boolean hasUserMobileToken(long userId, String mobileToken)
		throws SystemException {

		return getService().hasUserMobileToken(userId, mobileToken);
	}

	public static String refreshMobileToken(long userId, String mobileToken)
		throws SystemException {

		return getService().refreshMobileToken(userId, mobileToken);
	}
