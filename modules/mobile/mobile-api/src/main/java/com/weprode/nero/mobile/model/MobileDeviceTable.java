...
/**
 * The table class for the &quot;Mobile_MobileDevice&quot; database table.
 *
...
public class MobileDeviceTable extends BaseTable<MobileDeviceTable> {
	...
	public final Column<MobileDeviceTable, String> manufacturerDeviceId =
		createColumn(
			"manufacturerDeviceId", String.class, Types.VARCHAR,
			Column.FLAG_DEFAULT);
	...
	private MobileDeviceTable() {
		super("Mobile_MobileDevice", MobileDeviceTable::new);
	}
