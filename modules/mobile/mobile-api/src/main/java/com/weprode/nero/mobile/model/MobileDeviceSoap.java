...
/**
 * This class is used by SOAP remote services, specifically {@link com.weprode.nero.mobile.service.http.MobileDeviceServiceSoap}.
 *
...
public class MobileDeviceSoap implements Serializable {
	...
	public static MobileDeviceSoap toSoapModel(MobileDevice model) {
		...
		soapModel.setManufacturerDeviceId(model.getManufacturerDeviceId());
