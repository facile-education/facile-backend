...
public interface MobileDeviceLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.mobile.service.impl.MobileDeviceLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the mobile device local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MobileDeviceLocalServiceUtil} if injection and service tracking are not available.
	 */
