 ...
 * <code>com.weprode.facile.statistic.service.impl.GeneralStatLocalServiceImpl</code> and
...
public class GeneralStatLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.weprode.facile.statistic.service.impl.GeneralStatLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Map<Integer, Integer> countSchoolLifeStudents(
		java.util.Date startDate, java.util.Date endDate, long schoolId) {

		return getService().countSchoolLifeStudents(
