...
public interface LoolStatLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.nero.statistic.service.impl.LoolStatLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the lool stat local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LoolStatLocalServiceUtil} if injection and service tracking are not available.
	 */
