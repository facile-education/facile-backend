...
public class LoolStatModelImpl
	...
	private static Function<InvocationHandler, LoolStat>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			LoolStat.class.getClassLoader(), LoolStat.class,
			ModelWrapper.class);

		try {
			Constructor<LoolStat> constructor =
				(Constructor<LoolStat>)proxyClass.getConstructor(
	...
	public String toXmlString() {
		...
		for (Map.Entry<String, Function<LoolStat, Object>> entry :
			...
			sb.append(attributeGetterFunction.apply((LoolStat)this));
