...
import com.weprode.facile.statistic.model.GeneralStat;
 ...
 * @generated
 */
public abstract class GeneralStatFinderBaseImpl
	extends BasePersistenceImpl<GeneralStat> {

	public GeneralStatFinderBaseImpl() {
		setModelClass(GeneralStat.class);
	}
