...
/**
 * Provides the local service utility for LoginLock. This utility wraps
 * <code>com.weprode.facile.authentication.service.impl.LoginLockLocalServiceImpl</code> and
 ...
 * @generated
 */
public class LoginLockLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.weprode.facile.authentication.service.impl.LoginLockLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static void addLoginAttempt(String login) {
		getService().addLoginAttempt(login);
	}
	 ...
	 */
	public static LoginLock addLoginLock(LoginLock loginLock) {
		return getService().addLoginLock(loginLock);
	}
	 ...
	 */
	public static LoginLock createLoginLock(String login) {
		return getService().createLoginLock(login);
	}
	 ...
	 */
	public static LoginLock deleteLoginLock(LoginLock loginLock) {
		return getService().deleteLoginLock(loginLock);
	}
	 ...
	 */
	public static LoginLock deleteLoginLock(String login)
		throws PortalException {

		return getService().deleteLoginLock(login);
	}
	...
	public static LoginLock fetchLoginLock(String login) {
		return getService().fetchLoginLock(login);
	}
	 ...
	 * @throws PortalException if a login lock with the primary key could not be found
	 */
	public static LoginLock getLoginLock(String login) throws PortalException {
		return getService().getLoginLock(login);
	}
	 ...
	 */
	public static List<LoginLock> getLoginLocks(int start, int end) {
		return getService().getLoginLocks(start, end);
	}
	 ...
	 */
	public static int getLoginLocksCount() {
		return getService().getLoginLocksCount();
	}
	 ...
	 */
	public static LoginLock updateLoginLock(LoginLock loginLock) {
		return getService().updateLoginLock(loginLock);
	}

	public static LoginLockLocalService getService() {
		return _service;
	}

	private static volatile LoginLockLocalService _service;
