...
/**
 * The persistence utility for the help category service. This utility wraps <code>com.weprode.facile.help.service.persistence.impl.HelpCategoryPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class HelpCategoryUtil {
	...
	public static HelpCategory remove(long categoryId)
		throws com.weprode.facile.help.exception.NoSuchCategoryException {
