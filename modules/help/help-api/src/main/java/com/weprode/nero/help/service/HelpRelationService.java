...
/**
 * Provides the remote service interface for HelpRelation. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see HelpRelationServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface HelpRelationService extends BaseService {
	...
	@JSONWebService(method = "POST", value = "save-relation")
