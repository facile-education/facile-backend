...
/**
 * Provides the remote service interface for HelpLink. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see HelpLinkServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface HelpLinkService extends BaseService {
	...
	@JSONWebService(method = "POST", value = "save-link")
