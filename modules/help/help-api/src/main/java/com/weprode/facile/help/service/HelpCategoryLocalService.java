...
public interface HelpCategoryLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.help.service.impl.HelpCategoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the help category local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link HelpCategoryLocalServiceUtil} if injection and service tracking are not available.
	 */
