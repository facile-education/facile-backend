...
/**
 * Provides the local service interface for HelpQuestion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see HelpQuestionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface HelpQuestionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.facile.help.service.impl.HelpQuestionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the help question local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link HelpQuestionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public HelpQuestion addHelpQuestion(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public HelpQuestion getHelpQuestion(long questionId) throws PortalException;
