...
/**
 * Provides the local service interface for HelpCategory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see HelpCategoryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface HelpCategoryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.nero.help.service.impl.HelpCategoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the help category local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link HelpCategoryLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public HelpCategory getHelpCategory(long categoryId) throws PortalException;
