...
/**
 * Provides the remote service interface for HelpCategory. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see HelpCategoryServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface HelpCategoryService extends BaseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.weprode.nero.help.service.impl.HelpCategoryServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the help category remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link HelpCategoryServiceUtil} if injection and service tracking are not available.
	 */
	...
	@JSONWebService(method = "POST", value = "save-category")
