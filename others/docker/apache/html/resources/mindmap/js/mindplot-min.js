...
var b=this;
$(document).on("mousewheel",function(c){if(c.deltaY>0){b.zoomIn(1.05)
}else{b.zoomOut(1.05)
}c.preventDefault()
})
...
};mindplot.NeroPersistenceManager=new Class({Extends:mindplot.PersistenceManager,initialize:function(a){this.parent();
this.backendUrl=a
...
$.post(this.backendUrl+"/save-mind-file",{params:JSON.stringify(b)},function(k,j){e.onSave=false;
e.timestamp=k
})
}},discardChanges:function(a){},unlockMap:function(a){},_buildError:function(c){var b=c?c.globalErrors[0]:null;
...
$.ajax({url:this.backendUrl+"/get-mind-file?fileVersionId="+b,method:"get",async:false,headers:{"Content-Type":"text/plain",Accept:"application/xml"},success:function(c){a=c.content
}});
if(a==null){a='<map name="welcome" version="tango"><topic central="true" id="0"/></map>'
